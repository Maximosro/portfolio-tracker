...
class DcaServiceTest {
    ...
    void addEntry_recalculatesFromAllDca() {
        ...
        DcaEntry existingDca = DcaEntry.builder().ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build();
    ...
    void deleteEntry_recalculatesPositionFromRemainingDca() {
        ...
        DcaEntry toDelete = DcaEntry.builder().id(2L).ticker("VWCE").shares(5.0).price(120.0).date(LocalDate.of(2025, 3, 1)).build();
        DcaEntry remaining = DcaEntry.builder().id(1L).ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build();
    ...
    void deleteEntry_lastEntry_setsPositionToZero() {
        DcaEntry lastEntry = DcaEntry.builder().id(1L).ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build();
    ...
    void updateEntry_recalculatesPosition() {
        ...
        DcaEntry existingDca1 = DcaEntry.builder().id(1L).ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build();
        DcaEntry existingDca2 = DcaEntry.builder().id(2L).ticker("VWCE").shares(5.0).price(120.0).date(LocalDate.of(2025, 3, 1)).build();
        ...
        DcaEntry updatedDca2 = DcaEntry.builder().id(2L).ticker("VWCE").shares(5.0).price(80.0).date(LocalDate.of(2025, 3, 1)).build();
        when(dcaEntryRepository.findByTickerOrderByDateAsc("VWCE"))
                .thenReturn(List.of(existingDca1, updatedDca2));

        DcaEntry update = DcaEntry.builder().shares(5.0).price(80.0).date(LocalDate.of(2025, 3, 1)).build();
    ...
    void updateEntry_zeroShares_throws() {
        DcaEntry existing = DcaEntry.builder().id(1L).ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build();
    ...
    void recalculate_multipleEntries_correctAverage() {
        ...
        List<DcaEntry> entries = List.of(
                DcaEntry.builder().ticker("VWCE").shares(10.0).price(100.0).date(LocalDate.of(2025, 1, 1)).build(),
                DcaEntry.builder().ticker("VWCE").shares(5.0).price(120.0).date(LocalDate.of(2025, 2, 1)).build(),
                DcaEntry.builder().ticker("VWCE").shares(15.0).price(90.0).date(LocalDate.of(2025, 3, 1)).build()
        );
