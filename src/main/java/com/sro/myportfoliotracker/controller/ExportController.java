...
public class ExportController {
  ...
  /**
   * Genera y descarga un informe Markdown completo del portfolio, optimizado para ser usado como
   * contexto en conversaciones con IA (Claude).
   */
  ...
  public ResponseEntity<byte[]> exportReport() {
    ...
    String filename =
        "portfolio_report_" + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))
            + ".md";
