...
public class CompoundInterestRequest {
  ...
  /**
   * Cambios en la aportación mensual a lo largo del tiempo. Ej: [{fromYear: 5, amount: 700},
   * {fromYear: 10, amount: 1000}] Si es null o vacío, la aportación es constante.
   */
  private List<ContributionChange> contributionChanges;

  /**
   * Cambios en la rentabilidad a lo largo del tiempo. Ej: [{fromYear: 10, returnPct: 5}]
   */
