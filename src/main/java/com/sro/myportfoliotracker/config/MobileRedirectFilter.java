...
/**
 * Redirects mobile user agents (iOS/Android) to the mobile-optimized read-only view. Users can
 * bypass with ?desktop=true query parameter or a cookie.
 */
@Component
  ...
  protected void doFilterInternal(HttpServletRequest request,
    ...
    if ("/".equals(path) || "".equals(path) || "/index.html".equals(path)) {
      ...
      if ("true".equals(request.getParameter("desktop"))) {
        jakarta.servlet.http.Cookie cookie = new jakarta.servlet.http.Cookie("prefer_desktop",
            "true");
