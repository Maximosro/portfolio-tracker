...
/**
 * Convierte Instant ↔ String para SQLite. Almacena en formato "yyyy-MM-dd HH:mm:ss.SSSSSS"
 * (compatible con SQLite JDBC). Al leer, acepta tanto el formato con espacio como ISO-8601 (con T
 * y/o Z).
 */
@Converter
