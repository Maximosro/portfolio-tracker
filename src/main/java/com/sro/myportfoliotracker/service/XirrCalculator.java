...
/**
 * Calcula XIRR (Extended Internal Rate of Return) usando Newton-Raphson.
 * Flujos negativos = compras (dinero que sale).
 * Flujo positivo final = valor actual de la posición (dinero que "entra").
 */
public final class XirrCalculator {
    ...
    private static Double bisection(List<CashFlow> flows, LocalDate baseDate) {
        ...
        if (npvLow * npvHigh > 0) return null; // No hay raíz en este rango
