...
/**
 * Servicio de log funcional en memoria (ring buffer).
 * Almacena las últimas MAX_ENTRIES entradas de actividad de la aplicación:
 * actualizaciones de precios, envíos de Telegram, operaciones DCA,
